...
function DocumentarySection() {
    ...
    <div className="flex absolute bottom-0 right-0 rounded-br-2xl" style={{width: "calc(100% - 240px)", height: "calc(100% - 65px)"}}>
      ...
      <div id="sectionContent" className="p-2 bg-slate-900/[.6] absolute right-0 w-full top-[65px] overflow-scroll  rounded-br-2xl flex justify-center items-center" style={{height: "calc(100% - 65px)"}}>
