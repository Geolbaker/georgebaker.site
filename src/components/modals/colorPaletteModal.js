...
function ColorPaletteModal(){
  ...
  return (
    <div id="colorPaletteModal" className="container position-fixed m-5 invisible">
      <div className="position-fixed w-100 h-100 colorPaletteBackground" onClick={OpenColorPalette}></div>
      <div className=" popupBlockColor arrow-top">
        ...
        <div className="colorPalette" onClick={() => ChangeColorPalette('normal')}>
          <div className="d-flex p-2 colorPaletteSelection">
            <div className="col-3 d-inline rounded-left" style={{background: "rgb(255 255 255)"}}>
              {'\u00A0'}
            </div>
            ...
            <div className="col-3 d-inline rounded-right" style={{background: "rgb(38 57 77)"}}>
              {'\u00A0'}
            </div>
          </div>
        </div>
          ...
          <div className="colorPalette" onClick={() => ChangeColorPalette('botanical')}>
            <div className="d-flex p-2 colorPaletteSelection">
              <div className="col-3 d-inline rounded-left" style={{background: "rgb(114 144 141)"}}>
                {'\u00A0'}
              </div>
              ...
              <div className="col-3 d-inline rounded-right" style={{background: "rgb(73 87 85)"}}>
                {'\u00A0'}
              </div>
            </div>
          </div>
          ...
          <div className="colorPalette" onClick={() => ChangeColorPalette('witchgirl')}>
            <div className="d-flex p-2 colorPaletteSelection">
              <div className="col-3 d-inline rounded-left" style={{background: "rgb(231 200 190)"}}>
                {'\u00A0'}
              </div>
              ...
              <div className="col-3 d-inline rounded-right" style={{background: "rgb(220 180 167)"}}>
                {'\u00A0'}
              </div>
            </div>
          </div>
          ...
          <div className="colorPalette" onClick={() => ChangeColorPalette('alpine')}>
            <div className="d-flex p-2 colorPaletteSelection">
              <div className="col-3 d-inline rounded-left" style={{background: "rgb(118 115 140)"}}>
                {'\u00A0'}
              </div>
              ...
              <div className="col-3 d-inline rounded-right" style={{background: "rgb(119 115 140)"}}>
                {'\u00A0'}
              </div>
            </div>
          </div>
